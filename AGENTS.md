...
<name>browser-testing-with-screenshots</name>
<description>Skill for testing web applications with visual verification using Chrome DevTools Protocol for navigation, interaction, and screenshot capture</description>
<path>.openskills/browser-testing-with-screenshots/SKILL.md</path>
</skill>
